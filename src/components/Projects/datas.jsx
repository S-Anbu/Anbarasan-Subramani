...
import weldingshop from "../../assets/img/weldingshop.png"
import chatpro from "../../assets/img/chatpro.png"


const datas = [
    { image: weldingshop, title: 'Real time Website', description: "I created a real-time live welding shop website for a client, utilizing React for the front-end, Tailwind CSS for responsive design, and integrated Razorpay as the payment gateway for seamless transactions. The site offers real-time updates and a user-friendly experience.", url: "https://s-anbu.github.io/AADHI-Engineering-Works/" },
    { image: chatpro, title: 'Real Time Chat Application', description: "The Real-Time Chat Application is built with the MERN stack, Tailwind CSS, Redux Toolkit, and Socket.io for seamless real-time messaging. It features user authentication (JWT), typing indicators, read receipts, and online/offline status updates. With Redux for state management and Socket.io for instant communication, the app delivers a smooth and responsive chat experience on both mobile and desktop.", url: "https://chatpro-client.onrender.com/" },
    { image: Portfolio, title: 'React Portfolo', description: "A sleek and modern personal portfolio website built using React and styled with Tailwind CSS, showcasing projects, skills, and professional experience. Enhanced with additional supporting libraries for smooth navigation, responsiveness, and an optimized user experience.", url: "https://s-anbu.github.io/Anbarasan-Subramani/" },
